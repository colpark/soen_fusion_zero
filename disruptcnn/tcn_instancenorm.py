"""
TCN with Instance Normalization instead of Weight Normalization.

Same structure as tcn.py (TemporalBlock, TemporalConvNet) but conv layers are
plain Conv1d with InstanceNorm1d applied after each conv, instead of weight_norm(Conv1d).
Use this variant with --use-instance-norm when running training.
"""
...
class TemporalBlock(nn.Module):
    """Temporal block: Conv1d -> Chomp -> InstanceNorm1d -> ReLU -> Dropout (x2). No weight_norm."""
