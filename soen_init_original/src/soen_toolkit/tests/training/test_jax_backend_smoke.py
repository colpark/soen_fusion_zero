"""Smoke test for the JAX training backend."""
...
def _build_supported_core(input_dim: int, hidden_dim: int, output_dim: int) -> SOENModelCore:
...
def test_jax_backend_supervised_seq2static(tmp_path) -> None:
    """Run a minimal JAX training repeat end-to-end on synthetic classification data."""
    ...
    with make_temp_hdf5_pulse_classification(
        ...
        core = _build_supported_core(input_dim=1, hidden_dim=4, output_dim=num_classes)
