...
# Same as run_tcn_baseline_160_original_instancenorm_subsample.sh but decimated H5 (no memmap): --decimate-extra 10 gives same scaling as --decimate-factor 10.
# Data at 100k; decimate 10x (--decimate-extra 10) -> 10k, 7813 samples. input-channels 1.
EXTRA=()
